...
function getInputs() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const expiryDays = parseInt(core.getInput('expiry-period-in-days', {
            required: true,
            trimWhitespace: true,
        }), 10);
        if (isNaN(expiryDays)) {
        ...
        const branchNames = core.getMultilineInput('protect-branch-name', {
            required: false,
            trimWhitespace: true,
        });
        core.debug(`protect branches:${branchNames}`);
        const noMatterCommitAhead = core.getBooleanInput('is-force-delete', {
            required: true,
            trimWhitespace: true,
        });
